...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'body' => 'Контент',
        'price' => 'Цена',
        'title_tm' => 'Заголовок (тм)',
        'title_ru' => 'Заголовок (ру)',
        'title_en' => 'Заголовок (ен)',
        'image_tm' => 'Изображение (тм)',
        'image_ru' => 'Изображение (ру)',
        'image_en' => 'Изображение (ен)',
        'url' => 'Ссылка',
        ...
        'description_tm' => 'Описание (тм)',
        'description_ru' => 'Описание (ру)',
        'description_en' => 'Описание (ен)',
        'images' => 'Изображения',
        'title' => 'Заголовок',
