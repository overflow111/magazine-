...
@section('content')
    ...
    <div class="my-4">
        <form action="{{ route('admin.magazines.update', $obj->id) }}" method="post" enctype="multipart/form-data">
            {{ method_field('PUT') }}
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7 col-md-9">
                    <input id="title_tm" type="text"
                           ...
                           value="{{ $obj->title_tm }}" required autofocus>
                ...
                <div class="col-lg-7 col-md-9">
                    <div class="input-group date" id="published_at" data-target-input="nearest">
                        <input type="text"
                               ...
                               value="{{ date('d.m.Y H:i', strtotime($obj->published_at)) }}" required>
                    ...
                    <script>
                        function imageUpload(input) {
                            if (input.files && input.files[0]) {
                                ...
                                $('.image_upload').attr('src', "{{ asset('img/temp/magazine.png') }}");
                            }
                        }
                    </script>
                </div>
