...
@section('content')
    ...
    <div class="my-4">
        <form action="{{ route('admin.plans.update', $obj->id) }}" method="post">
            {{ method_field('PUT') }}
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-4 col-md-8">
                    <input id="month" type="number" min="1" max="36"
                           class="form-control{{ $errors->has('month') ? ' is-invalid' : '' }}" name="month"
                           value="{{ $obj->month }}" required>
                    @if($errors->has('month'))
                        <span class="invalid-feedback" role="alert">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-4 col-md-8">
                    <input id="download" type="number" min="1" max="36"
                           class="form-control{{ $errors->has('download') ? ' is-invalid' : '' }}" name="download"
                           value="{{ $obj->download }}" required>
