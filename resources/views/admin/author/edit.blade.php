...
@section('content')
    ...
    <div class="my-4">
        <form action="{{ route('admin.authors.update', $obj->id) }}" method="post" enctype="multipart/form-data">
            {{ method_field('PUT') }}
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7 col-md-9">
                    <textarea id="job_tm"
                              ...
                              name="job_tm" rows="2" required>{!! $obj->job_tm !!}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7 col-md-9">
                    <textarea id="job_ru"
                              ...
                              name="job_ru" rows="2">{{ $obj->job_ru }}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-7 col-md-9">
                    <textarea id="job_en"
                              ...
                              name="job_en" rows="2">{{ $obj->job_en }}</textarea>
                    ...
                    <script>
                        function imageUpload(input) {
                            if (input.files && input.files[0]) {
                                ...
                                $('.image_upload').attr('src', "{{ asset('img/temp/author.png') }}");
                            }
                        }
                    </script>
                </div>
